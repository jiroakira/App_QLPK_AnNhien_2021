...
class ProgressHud extends StatefulWidget {
  ...
  ProgressHud({Key key, @required this.child, this.offsetY = -50, this.isGlobalHud = false, this.maximumDismissDuration}) : super(key: key);
      ...
      case ProgressHudType.loading:
        var sizeBox = SizedBox(
          ...
          child: CupertinoTheme(
              data: CupertinoTheme.of(context).copyWith(brightness: Brightness.dark), child: CupertinoActivityIndicator(animating: true, radius: 15)),
        );
      ...
      children: <Widget>[
        ...
        Center(
          child: Container(
            ...
            decoration: BoxDecoration(color: Color.fromARGB(255, 33, 33, 33), borderRadius: BorderRadius.circular(5)),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Text(_text, textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 16)),
                  )
                ],
              ),
            ),
