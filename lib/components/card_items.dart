                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          Text(
                            '$title',
                            style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Constants.textPrimary),
                          ),
                          Text(
                            '$value $unit',
                      ...
                      (progress == 0 || progress == null)
                          ? Text('Not started', style: TextStyle(fontSize: 15, color: Constants.textPrimary))
                          : Container(
                              height: 6,
                              decoration: new BoxDecoration(
                                borderRadius: BorderRadius.all(Radius.circular(10.0)),
